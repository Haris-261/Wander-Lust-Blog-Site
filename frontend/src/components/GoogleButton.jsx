...
export default function GoogleButton({ label = 'Continue with Google' }) {
  ...
  return (
    <button type="button" className="btn btn--google" onClick={startGoogle}>
      <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.2-3.5 5.7-6.5 7.1l.1.1 6.2 5.2C36.8 39 44 34 44 24c0-1.2-.1-2.3-.4-3.5z"
        />
      </svg>
      {label}
    </button>
